...
<div class="container text-center">
    <div class="row">
        <div class="col-lg-4 well">
                                    ...
                                    <div class="row">
                                        <form action="" >
                                            <div class="form-group">
                                                <textarea id="newMessageText" style="text-align: justify" class="form-control" rows="5"></textarea>
                                            </div>
            ...
            <div class="well">
                ...
                <ul id="disciplinesList" class="list-group">
                    <c:forEach var="link" items="${disciplinesLinksList}">
        ...
        <div class="col-lg-8">
            ...
            <c:forEach var="feedback" items="${usersFeedbacksList}">
